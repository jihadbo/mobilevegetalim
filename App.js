...
function LoginStackScreen() {
  return (
    <LoginStack.Navigator>
      ...
      <LoginStack.Screen name="AdminSignIn" component={AdminSignIn} options={{ headerBackVisible: false }}/>
      <LoginStack.Screen name="Admin" component={Admin} options={{ headerBackVisible: false }}/>
      <LoginStack.Screen name="Recette" component={AllRecette} options={{ headerBackVisible: false }}/>
    </LoginStack.Navigator>
  );
}
...
//   return (
//     <LoginStack.Navigator>
//       <LoginStack.Screen name="SignIn" component={SignIn} options={{ headerBackVisible: false }}/>
//       <LoginStack.Screen name="AdminSignIn" component={AdminSignIn} options={{ headerBackVisible: false }}/>
//       <LoginStack.Screen name="Admin" component={Admin} options={{ headerBackVisible: false }}/>
//       <LoginStack.Screen name="Recette" component={AllRecette} options={{ headerBackVisible: false }}/>
//     </LoginStack.Navigator>
...
//           </TouchableOpacity>
//           <Text style={styles.topText}>Veget'Alim</Text>
//           <TouchableOpacity onPress={() => LoginStackScreen()} style={styles.profileButton}>
//             <Image
//             style={{width: 30, height: 30}}
//             source={{uri:'https://icon-library.com/images/white-profile-icon/white-profile-icon-6.jpg'}}
//             />
